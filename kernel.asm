...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 6b 78 10 80 	movl   $0x8010786b,(%esp)
...
801009a6:	81 ec 2c 01 00 00    	sub    $0x12c,%esp
  uint argc, sz, sp,firstpage, ustack[3+MAXARG+1];
  struct elfhdr elf;
  struct inode *ip;
  struct proghdr ph;
...
80100b40:	e8 1b 20 00 00       	call   80102b60 <end_op>
  if((firstpage=allocuvm(pgdir, UNDERKERN-PGSIZE, UNDERKERN)) == 0)
80100b45:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b4b:	c7 44 24 08 99 99 99 	movl   $0x79999999,0x8(%esp)
80100b52:	79 
80100b53:	c7 44 24 04 99 89 99 	movl   $0x79998999,0x4(%esp)
80100b5a:	79 
...
80100c20:	e8 3b 1f 00 00       	call   80102b60 <end_op>
    cprintf("exec: fail\n");
80100c25:	c7 04 24 81 6e 10 80 	movl   $0x80106e81,(%esp)
...
80100c7d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c83:	e8 58 60 00 00       	call   80106ce0 <copyout>
...
80100cfe:	e8 0d 59 00 00       	call   80106610 <switchuvm>
  freevm(oldpgdir);
80100d03:	89 34 24             	mov    %esi,(%esp)
80100d06:	e8 85 5c 00 00       	call   80106990 <freevm>
  return 0;
...
80102d87:	e8 14 27 00 00       	call   801054a0 <idtinit>
...
80102db3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102db6:	e8 35 38 00 00       	call   801065f0 <switchkvm>
  seginit();
80102dbb:	e8 f0 36 00 00       	call   801064b0 <seginit>
  lapicinit();
...
80102df3:	e8 a8 3c 00 00       	call   80106aa0 <kvmalloc>
...
80102e05:	e8 a6 36 00 00       	call   801064b0 <seginit>
  picinit();       // disable pic
...
80102e1a:	e8 31 2a 00 00       	call   80105850 <uartinit>
80102e1f:	90                   	nop
  pinit();         // process table
...
80102e25:	e8 46 3f 00 00       	call   80106d70 <shminit>
  tvinit();        // trap vectors
80102e2a:	e8 d1 25 00 00       	call   80105400 <tvinit>
80102e2f:	90                   	nop
  binit();         // buffer cache
...
8010350d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103510:	c7 40 14 f5 53 10 80 	movl   $0x801053f5,0x14(%eax)
...
801036c3:	e8 48 33 00 00       	call   80106a10 <setupkvm>
...
801036e5:	80 
801036e6:	e8 35 30 00 00       	call   80106720 <inituvm>
  p->sz = PGSIZE;
...
801037e9:	e8 82 30 00 00       	call   80106870 <allocuvm>
...
801037f7:	e8 14 2e 00 00       	call   80106610 <switchuvm>
  return 0;
...
8010381a:	e8 51 31 00 00       	call   80106970 <deallocuvm>
...
8010385e:	e8 8d 32 00 00       	call   80106af0 <copyuvm>
...
80103992:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
80103995:	e8 76 2c 00 00       	call   80106610 <switchuvm>
...
801039ab:	e8 eb 0a 00 00       	call   8010449b <swtch>
      switchkvm();
801039b0:	e8 3b 2c 00 00       	call   801065f0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103d18:	e8 73 2c 00 00       	call   80106990 <freevm>
        release(&ptable.lock);
...
80103e64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e68:	c7 04 24 6b 78 10 80 	movl   $0x8010786b,(%esp)
...
801044d6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ep = (char*)UNDERKERN;
  for(s = *pp; s < ep; s++){
801044d9:	81 fa 98 99 99 79    	cmp    $0x79999998,%edx
  *pp = (char*)addr;
...
801044f8:	3d 99 99 99 79       	cmp    $0x79999999,%eax
...
80104547:	8b 5d 10             	mov    0x10(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010454a:	e8 31 f1 ff ff       	call   80103680 <myproc>
  *ip = *(int*)(addr);
8010454f:	8b 55 08             	mov    0x8(%ebp),%edx
  int i;
  //struct proc *curproc = myproc();
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= UNDERKERN || (uint)i+size > UNDERKERN)
80104552:	85 db                	test   %ebx,%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104554:	8b 40 18             	mov    0x18(%eax),%eax
  *ip = *(int*)(addr);
80104557:	8b 40 44             	mov    0x44(%eax),%eax
8010455a:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
  if(size < 0 || (uint)i >= UNDERKERN || (uint)i+size > UNDERKERN)
8010455e:	78 20                	js     80104580 <argptr+0x40>
80104560:	3d 98 99 99 79       	cmp    $0x79999998,%eax
80104565:	77 19                	ja     80104580 <argptr+0x40>
80104567:	01 c3                	add    %eax,%ebx
80104569:	81 fb 99 99 99 79    	cmp    $0x79999999,%ebx
8010456f:	77 0f                	ja     80104580 <argptr+0x40>
    return -1;
  *pp = (char*)i;
...
80104585:	eb f1                	jmp    80104578 <argptr+0x38>
...
80104593:	83 ec 08             	sub    $0x8,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104596:	e8 e5 f0 ff ff       	call   80103680 <myproc>
  *ip = *(int*)(addr);
8010459b:	8b 55 08             	mov    0x8(%ebp),%edx
  *pp = (char*)addr;
8010459e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801045a1:	8b 40 18             	mov    0x18(%eax),%eax
  *ip = *(int*)(addr);
801045a4:	8b 40 44             	mov    0x44(%eax),%eax
801045a7:	8b 54 90 04          	mov    0x4(%eax,%edx,4),%edx
  for(s = *pp; s < ep; s++){
801045ab:	81 fa 98 99 99 79    	cmp    $0x79999998,%edx
  *pp = (char*)addr;
801045b1:	89 11                	mov    %edx,(%ecx)
  for(s = *pp; s < ep; s++){
801045b3:	77 1a                	ja     801045cf <argstr+0x3f>
    if(*s == 0)
801045b5:	80 3a 00             	cmpb   $0x0,(%edx)
801045b8:	89 d0                	mov    %edx,%eax
801045ba:	75 09                	jne    801045c5 <argstr+0x35>
801045bc:	eb 1a                	jmp    801045d8 <argstr+0x48>
801045be:	66 90                	xchg   %ax,%ax
801045c0:	80 38 00             	cmpb   $0x0,(%eax)
801045c3:	74 13                	je     801045d8 <argstr+0x48>
  for(s = *pp; s < ep; s++){
801045c5:	83 c0 01             	add    $0x1,%eax
801045c8:	3d 98 99 99 79       	cmp    $0x79999998,%eax
801045cd:	76 f1                	jbe    801045c0 <argstr+0x30>
  return -1;
...
801045e5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801045e8:	e8 93 f0 ff ff       	call   80103680 <myproc>
...
801045fd:	8b 14 85 e0 74 10 80 	mov    -0x7fef8b20(,%eax,4),%edx
...
80104626:	c7 04 24 b1 74 10 80 	movl   $0x801074b1,(%esp)
...
80104656:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104659:	e8 22 f0 ff ff       	call   80103680 <myproc>
...
801046ac:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801046af:	e8 4c d8 ff ff       	call   80101f00 <nameiparent>
...
801046c1:	e8 ca cf ff ff       	call   80101690 <ilock>
...
8010470b:	e8 e0 d1 ff ff       	call   801018f0 <iunlockput>
}
...
8010472d:	e8 ce cd ff ff       	call   80101500 <ialloc>
...
8010473f:	e8 4c cf ff ff       	call   80101690 <ilock>
  ip->major = major;
...
80104760:	e8 6b ce ff ff       	call   801015d0 <iupdate>
...
8010482a:	e8 e1 fc ff ff       	call   80104510 <argint>
...
80104839:	e8 42 ee ff ff       	call   80103680 <myproc>
...
801048a9:	e8 02 c5 ff ff       	call   80100db0 <filedup>
  return fd;
...
801048e2:	e8 29 fc ff ff       	call   80104510 <argint>
...
80104900:	e8 3b fc ff ff       	call   80104540 <argptr>
...
8010491d:	e8 ee c5 ff ff       	call   80100f10 <fileread>
}
80104922:	c9                   	leave  
80104923:	c3                   	ret    
...
80104952:	e8 b9 fb ff ff       	call   80104510 <argint>
...
80104970:	e8 cb fb ff ff       	call   80104540 <argptr>
...
8010498d:	e8 1e c6 ff ff       	call   80100fb0 <filewrite>
}
80104992:	c9                   	leave  
80104993:	c3                   	ret    
...
801049b3:	78 23                	js     801049d8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
801049b5:	e8 c6 ec ff ff       	call   80103680 <myproc>
...
801049cb:	e8 30 c4 ff ff       	call   80100e00 <fileclose>
  return 0;
...
80104a0a:	e8 31 fb ff ff       	call   80104540 <argptr>
...
80104a20:	e8 9b c4 ff ff       	call   80100ec0 <filestat>
}
80104a25:	c9                   	leave  
80104a26:	c3                   	ret    
80104a27:	90                   	nop
...
80104a47:	e8 44 fb ff ff       	call   80104590 <argstr>
...
80104a8c:	e8 ff cb ff ff       	call   80101690 <ilock>
  if(ip->type == T_DIR){
...
80104aa7:	e8 24 cb ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
80104aac:	89 1c 24             	mov    %ebx,(%esp)
80104aaf:	e8 bc cc ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104ab4:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104ab7:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104abb:	89 04 24             	mov    %eax,(%esp)
80104abe:	e8 3d d4 ff ff       	call   80101f00 <nameiparent>
...
80104ae5:	e8 16 d3 ff ff       	call   80101e00 <dirlink>
80104aea:	85 c0                	test   %eax,%eax
80104aec:	78 22                	js     80104b10 <sys_link+0xe0>
  iunlockput(dp);
80104aee:	89 34 24             	mov    %esi,(%esp)
80104af1:	e8 fa cd ff ff       	call   801018f0 <iunlockput>
  iput(ip);
80104af6:	89 1c 24             	mov    %ebx,(%esp)
80104af9:	e8 b2 cc ff ff       	call   801017b0 <iput>
  end_op();
80104afe:	e8 5d e0 ff ff       	call   80102b60 <end_op>
}
...
80104b13:	e8 d8 cd ff ff       	call   801018f0 <iunlockput>
  ilock(ip);
80104b18:	89 1c 24             	mov    %ebx,(%esp)
80104b1b:	e8 70 cb ff ff       	call   80101690 <ilock>
  ip->nlink--;
80104b20:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104b25:	89 1c 24             	mov    %ebx,(%esp)
80104b28:	e8 a3 ca ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
80104b2d:	89 1c 24             	mov    %ebx,(%esp)
80104b30:	e8 bb cd ff ff       	call   801018f0 <iunlockput>
  end_op();
80104b35:	e8 26 e0 ff ff       	call   80102b60 <end_op>
}
...
80104b67:	e8 24 fa ff ff       	call   80104590 <argstr>
80104b6c:	85 c0                	test   %eax,%eax
80104b6e:	0f 88 76 01 00 00    	js     80104cea <sys_unlink+0x19a>
  begin_op();
80104b74:	e8 77 df ff ff       	call   80102af0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104b86:	e8 75 d3 ff ff       	call   80101f00 <nameiparent>
...
80104b9c:	e8 ef ca ff ff       	call   80101690 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104ba1:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104ba8:	80 
80104ba9:	89 1c 24             	mov    %ebx,(%esp)
80104bac:	e8 bf cf ff ff       	call   80101b70 <namecmp>
80104bb1:	85 c0                	test   %eax,%eax
80104bb3:	0f 84 21 01 00 00    	je     80104cda <sys_unlink+0x18a>
80104bb9:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104bc0:	80 
80104bc1:	89 1c 24             	mov    %ebx,(%esp)
80104bc4:	e8 a7 cf ff ff       	call   80101b70 <namecmp>
...
80104bdf:	e8 bc cf ff ff       	call   80101ba0 <dirlookup>
...
80104bf1:	e8 9a ca ff ff       	call   80101690 <ilock>
  if(ip->nlink < 1)
...
80104c1e:	e8 3d f6 ff ff       	call   80104260 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104c3c:	e8 ff cd ff ff       	call   80101a40 <writei>
...
80104cc1:	e8 7a cc ff ff       	call   80101940 <readi>
...
80104cd5:	e8 16 cc ff ff       	call   801018f0 <iunlockput>
  iunlockput(dp);
80104cda:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104cdd:	89 04 24             	mov    %eax,(%esp)
80104ce0:	e8 0b cc ff ff       	call   801018f0 <iunlockput>
  end_op();
80104ce5:	e8 76 de ff ff       	call   80102b60 <end_op>
}
...
80104d03:	e8 c8 c8 ff ff       	call   801015d0 <iupdate>
80104d08:	e9 48 ff ff ff       	jmp    80104c55 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104d0d:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
80104d14:	e8 47 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d19:	c7 04 24 92 75 10 80 	movl   $0x80107592,(%esp)
80104d20:	e8 3b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d25:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
...
80104d57:	e8 34 f8 ff ff       	call   80104590 <argstr>
...
80104d72:	e8 99 f7 ff ff       	call   80104510 <argint>
80104d77:	85 c0                	test   %eax,%eax
80104d79:	0f 88 b6 00 00 00    	js     80104e35 <sys_open+0xf5>
    return -1;

  begin_op();
80104d7f:	e8 6c dd ff ff       	call   80102af0 <begin_op>
...
80104d94:	e8 47 d1 ff ff       	call   80101ee0 <namei>
...
80104da6:	e8 e5 c8 ff ff       	call   80101690 <ilock>
...
80104db6:	e8 85 bf ff ff       	call   80100d40 <filealloc>
...
80104dd7:	e8 94 c9 ff ff       	call   80101770 <iunlock>
  end_op();
80104ddc:	e8 7f dd ff ff       	call   80102b60 <end_op>
...
80104e2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80104e30:	e8 2b dd ff ff       	call   80102b60 <end_op>
}
...
80104ebf:	e8 2c ca ff ff       	call   801018f0 <iunlockput>
  end_op();
80104ec4:	e8 97 dc ff ff       	call   80102b60 <end_op>
  return 0;
...
80104ecd:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80104ed0:	e8 8b dc ff ff       	call   80102b60 <end_op>
    return -1;
...
80104f10:	e8 fb f5 ff ff       	call   80104510 <argint>
  if((argstr(0, &path)) < 0 ||
...
80104f27:	e8 e4 f5 ff ff       	call   80104510 <argint>
     argint(1, &major) < 0 ||
...
80104f4f:	e8 9c c9 ff ff       	call   801018f0 <iunlockput>
  end_op();
80104f54:	e8 07 dc ff ff       	call   80102b60 <end_op>
  return 0;
...
80104f5d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80104f60:	e8 fb db ff ff       	call   80102b60 <end_op>
    return -1;
...
80104fa1:	e8 3a cf ff ff       	call   80101ee0 <namei>
...
80104faf:	e8 dc c6 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
80104fbc:	75 22                	jne    80104fe0 <sys_chdir+0x70>
  ...
  iunlock(ip);
80104fbe:	e8 ad c7 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
80104fc3:	8b 46 68             	mov    0x68(%esi),%eax
80104fc6:	89 04 24             	mov    %eax,(%esp)
80104fc9:	e8 e2 c7 ff ff       	call   801017b0 <iput>
  end_op();
80104fce:	e8 8d db ff ff       	call   80102b60 <end_op>
  curproc->cwd = ip;
  return 0;
...
80104fe0:	e8 0b c9 ff ff       	call   801018f0 <iunlockput>
    end_op();
80104fe5:	e8 76 db ff ff       	call   80102b60 <end_op>
}
...
8010501d:	e8 6e f5 ff ff       	call   80104590 <argstr>
...
8010503b:	e8 d0 f4 ff ff       	call   80104510 <argint>
...
8010506b:	e8 f0 f1 ff ff       	call   80104260 <memset>
    if(i >= NELEM(argv))
      return -1;
...
80105080:	e8 2b f4 ff ff       	call   801044b0 <fetchint>
...
8010509a:	e8 31 f4 ff ff       	call   801044d0 <fetchstr>
...
8010510d:	e8 2e f4 ff ff       	call   80104540 <argptr>
...
80105123:	e8 28 e0 ff ff       	call   80103150 <pipealloc>
...
801051a4:	e8 67 f3 ff ff       	call   80104510 <argint>
...
801051c3:	e8 78 f3 ff ff       	call   80104540 <argptr>
...
801051d9:	e8 f2 1b 00 00       	call   80106dd0 <shm_open>
}
801051de:	c9                   	leave  
801051df:	c3                   	ret    
    return -1;
...
80105204:	e8 07 f3 ff ff       	call   80104510 <argint>
...
80105213:	e8 c8 1b 00 00       	call   80106de0 <shm_close>
}
80105218:	c9                   	leave  
80105219:	c3                   	ret    
...
80105233:	5d                   	pop    %ebp
  return fork();
80105234:	e9 f7 e5 ff ff       	jmp    80103830 <fork>
...
80105243:	83 ec 08             	sub    $0x8,%esp
  exit();
80105246:	e8 35 e8 ff ff       	call   80103a80 <exit>
...
80105253:	5d                   	pop    %ebp
  return wait();
80105254:	e9 37 ea ff ff       	jmp    80103c90 <wait>
...
80105274:	e8 97 f2 ff ff       	call   80104510 <argint>
...
80105283:	e8 48 eb ff ff       	call   80103dd0 <kill>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
801052a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801052a6:	e8 d5 e3 ff ff       	call   80103680 <myproc>
...
801052c5:	e8 46 f2 ff ff       	call   80104510 <argint>
801052ca:	85 c0                	test   %eax,%eax
801052cc:	78 22                	js     801052f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801052ce:	e8 ad e3 ff ff       	call   80103680 <myproc>
  if(growproc(n) < 0)
...
801052db:	e8 e0 e4 ff ff       	call   801037c0 <growproc>
...
8010534f:	e8 8c e8 ff ff       	call   80103be0 <sleep>
  while(ticks - ticks0 < n){
...
8010535e:	73 28                	jae    80105388 <sys_sleep+0x88>
    if(myproc()->killed){
80105360:	e8 1b e3 ff ff       	call   80103680 <myproc>
...
80105373:	e8 98 ee ff ff       	call   80104210 <release>
      return -1;
...
8010538f:	e8 7c ee ff ff       	call   80104210 <release>
}
...
80105459:	c7 44 24 04 a1 75 10 	movl   $0x801075a1,0x4(%esp)
80105460:	80 
...
80105486:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010548c:	e8 9f eb ff ff       	call   80104030 <initlock>
}
80105491:	c9                   	leave  
80105492:	c3                   	ret    
...
801054e2:	0f 84 10 02 00 00    	je     801056f8 <trap+0x228>
    if(myproc()->killed)
      exit();
    return;
  }
...
801054f0:	ff 24 85 ec 76 10 80 	jmp    *-0x7fef8914(,%eax,4)
801054f7:	90                   	nop
    }
    break;
...
801054f8:	e8 83 e1 ff ff       	call   80103680 <myproc>
801054fd:	85 c0                	test   %eax,%eax
801054ff:	90                   	nop
80105500:	0f 84 8c 02 00 00    	je     80105792 <trap+0x2c2>
80105506:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010550a:	0f 84 82 02 00 00    	je     80105792 <trap+0x2c2>
...
8010551c:	e8 3f e1 ff ff       	call   80103660 <cpuid>
...
8010552c:	e8 4f e1 ff ff       	call   80103680 <myproc>
80105531:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105534:	e8 47 e1 ff ff       	call   80103680 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105563:	c7 04 24 a8 76 10 80 	movl   $0x801076a8,(%esp)
8010556a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010556e:	e8 dd b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105573:	e8 08 e1 ff ff       	call   80103680 <myproc>
...
80105589:	e8 f2 e0 ff ff       	call   80103680 <myproc>
...
80105595:	e8 e6 e0 ff ff       	call   80103680 <myproc>
...
801055a9:	74 4d                	je     801055f8 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801055ab:	e8 d0 e0 ff ff       	call   80103680 <myproc>
801055b0:	85 c0                	test   %eax,%eax
801055b2:	74 1d                	je     801055d1 <trap+0x101>
801055b4:	e8 c7 e0 ff ff       	call   80103680 <myproc>
...
801055cb:	0f 84 58 01 00 00    	je     80105729 <trap+0x259>
    exit();
}
...
801055eb:	75 a8                	jne    80105595 <trap+0xc5>
    exit();
801055ed:	e8 8e e4 ff ff       	call   80103a80 <exit>
...
80105600:	75 a9                	jne    801055ab <trap+0xdb>
    yield();
80105602:	e8 99 e5 ff ff       	call   80103ba0 <yield>
80105607:	eb a2                	jmp    801055ab <trap+0xdb>
80105609:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105610:	0f 20 d6             	mov    %cr2,%esi
    int rightbelowstack=PGROUNDUP(UNDERKERN-myproc()->pages*PGSIZE);
80105613:	e8 68 e0 ff ff       	call   80103680 <myproc>
80105618:	8b 40 7c             	mov    0x7c(%eax),%eax
8010561b:	f7 d8                	neg    %eax
8010561d:	c1 e0 0c             	shl    $0xc,%eax
80105620:	8d b8 00 a0 99 79    	lea    0x7999a000(%eax),%edi
    if(offendingaddress<rightbelowstack)
80105626:	39 fe                	cmp    %edi,%esi
80105628:	0f 8d 52 ff ff ff    	jge    80105580 <trap+0xb0>
	if(allocuvm(myproc()->pgdir,rightbelowstack-PGSIZE,rightbelowstack)==0)
8010562e:	e8 4d e0 ff ff       	call   80103680 <myproc>
80105633:	89 7c 24 08          	mov    %edi,0x8(%esp)
80105637:	81 ef 00 10 00 00    	sub    $0x1000,%edi
8010563d:	89 7c 24 04          	mov    %edi,0x4(%esp)
80105641:	8b 40 04             	mov    0x4(%eax),%eax
80105644:	89 04 24             	mov    %eax,(%esp)
80105647:	e8 24 12 00 00       	call   80106870 <allocuvm>
8010564c:	85 c0                	test   %eax,%eax
8010564e:	0f 84 1c 01 00 00    	je     80105770 <trap+0x2a0>
	myproc()->pages++;
80105654:	e8 27 e0 ff ff       	call   80103680 <myproc>
80105659:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
	cprintf("case T_PGFLT from trap.c: allocuvm succeeded. Number of pages allocated: %d\n", myproc()->pages); 
8010565d:	e8 1e e0 ff ff       	call   80103680 <myproc>
80105662:	8b 40 7c             	mov    0x7c(%eax),%eax
80105665:	c7 04 24 24 76 10 80 	movl   $0x80107624,(%esp)
8010566c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105670:	e8 db af ff ff       	call   80100650 <cprintf>
80105675:	e9 06 ff ff ff       	jmp    80105580 <trap+0xb0>
8010567a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105680:	e8 db df ff ff       	call   80103660 <cpuid>
80105685:	85 c0                	test   %eax,%eax
80105687:	0f 84 b3 00 00 00    	je     80105740 <trap+0x270>
8010568d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105690:	e8 cb d0 ff ff       	call   80102760 <lapiceoi>
    break;
80105695:	e9 e6 fe ff ff       	jmp    80105580 <trap+0xb0>
8010569a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    kbdintr();
801056a0:	e8 0b cf ff ff       	call   801025b0 <kbdintr>
    lapiceoi();
801056a5:	e8 b6 d0 ff ff       	call   80102760 <lapiceoi>
    break;
801056aa:	e9 d1 fe ff ff       	jmp    80105580 <trap+0xb0>
801056af:	90                   	nop
    uartintr();
801056b0:	e8 3b 02 00 00       	call   801058f0 <uartintr>
    lapiceoi();
801056b5:	e8 a6 d0 ff ff       	call   80102760 <lapiceoi>
    break;
801056ba:	e9 c1 fe ff ff       	jmp    80105580 <trap+0xb0>
801056bf:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801056c0:	8b 7b 38             	mov    0x38(%ebx),%edi
801056c3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801056c7:	e8 94 df ff ff       	call   80103660 <cpuid>
801056cc:	c7 04 24 ac 75 10 80 	movl   $0x801075ac,(%esp)
...
801056df:	e8 6c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
801056e4:	e8 77 d0 ff ff       	call   80102760 <lapiceoi>
    break;
801056e9:	e9 92 fe ff ff       	jmp    80105580 <trap+0xb0>
801056ee:	66 90                	xchg   %ax,%ax
    ideintr();
801056f0:	e8 6b c9 ff ff       	call   80102060 <ideintr>
801056f5:	eb 96                	jmp    8010568d <trap+0x1bd>
801056f7:	90                   	nop
801056f8:	90                   	nop
801056f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105700:	e8 7b df ff ff       	call   80103680 <myproc>
80105705:	8b 70 24             	mov    0x24(%eax),%esi
80105708:	85 f6                	test   %esi,%esi
8010570a:	75 2c                	jne    80105738 <trap+0x268>
    myproc()->tf = tf;
8010570c:	e8 6f df ff ff       	call   80103680 <myproc>
80105711:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105714:	e8 c7 ee ff ff       	call   801045e0 <syscall>
    if(myproc()->killed)
80105719:	e8 62 df ff ff       	call   80103680 <myproc>
8010571e:	8b 48 24             	mov    0x24(%eax),%ecx
80105721:	85 c9                	test   %ecx,%ecx
80105723:	0f 84 a8 fe ff ff    	je     801055d1 <trap+0x101>
}
...
8010572f:	5d                   	pop    %ebp
      exit();
80105730:	e9 4b e3 ff ff       	jmp    80103a80 <exit>
80105735:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105738:	e8 43 e3 ff ff       	call   80103a80 <exit>
8010573d:	eb cd                	jmp    8010570c <trap+0x23c>
8010573f:	90                   	nop
      acquire(&tickslock);
80105740:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105747:	e8 d4 e9 ff ff       	call   80104120 <acquire>
      wakeup(&ticks);
8010574c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105753:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010575a:	e8 11 e6 ff ff       	call   80103d70 <wakeup>
      release(&tickslock);
8010575f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105766:	e8 a5 ea ff ff       	call   80104210 <release>
8010576b:	e9 1d ff ff ff       	jmp    8010568d <trap+0x1bd>
...
80105775:	8b 40 7c             	mov    0x7c(%eax),%eax
80105778:	c7 04 24 d0 75 10 80 	movl   $0x801075d0,(%esp)
8010577f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105783:	e8 c8 ae ff ff       	call   80100650 <cprintf>
	   exit();
80105788:	e8 f3 e2 ff ff       	call   80103a80 <exit>
8010578d:	e9 c2 fe ff ff       	jmp    80105654 <trap+0x184>
80105792:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105795:	8b 73 38             	mov    0x38(%ebx),%esi
80105798:	e8 c3 de ff ff       	call   80103660 <cpuid>
8010579d:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057a1:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057a5:	89 44 24 08          	mov    %eax,0x8(%esp)
801057a9:	8b 43 30             	mov    0x30(%ebx),%eax
801057ac:	c7 04 24 74 76 10 80 	movl   $0x80107674,(%esp)
801057b3:	89 44 24 04          	mov    %eax,0x4(%esp)
801057b7:	e8 94 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057bc:	c7 04 24 a6 75 10 80 	movl   $0x801075a6,(%esp)
801057c3:	e8 98 ab ff ff       	call   80100360 <panic>
...
80105827:	e8 54 cf ff ff       	call   80102780 <microdelay>
...
801058b7:	00 
  for(p="xv6...\n"; *p; p++)
801058b8:	bb b4 77 10 80       	mov    $0x801077b4,%ebx
  ioapicenable(IRQ_COM1, 0);
801058bd:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801058c4:	e8 c7 c9 ff ff       	call   80102290 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
801063c4:	e8 b7 c0 ff ff       	call   80102480 <kalloc>
...
801063e2:	e8 79 de ff ff       	call   80104260 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106453:	e8 78 be ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
8010649a:	c3                   	ret    
        panic("kfree");
8010649b:	c7 04 24 66 70 10 80 	movl   $0x80107066,(%esp)
...
801064b3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801064b6:	e8 a5 d1 ff ff       	call   80103660 <cpuid>
...
801065e1:	c3                   	ret    
      panic("remap");
801065e2:	c7 04 24 bc 77 10 80 	movl   $0x801077bc,(%esp)
...
80106634:	0f 84 c3 00 00 00    	je     801066fd <switchuvm+0xed>
  pushcli();
8010663a:	e8 a1 da ff ff       	call   801040e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010663f:	e8 9c cf ff ff       	call   801035e0 <mycpu>
80106644:	89 c3                	mov    %eax,%ebx
80106646:	e8 95 cf ff ff       	call   801035e0 <mycpu>
8010664b:	89 c7                	mov    %eax,%edi
8010664d:	e8 8e cf ff ff       	call   801035e0 <mycpu>
...
801066eb:	5d                   	pop    %ebp
  popcli();
801066ec:	e9 af da ff ff       	jmp    801041a0 <popcli>
    panic("switchuvm: no process");
801066f1:	c7 04 24 c2 77 10 80 	movl   $0x801077c2,(%esp)
801066f8:	e8 63 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066fd:	c7 04 24 ed 77 10 80 	movl   $0x801077ed,(%esp)
80106704:	e8 57 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106709:	c7 04 24 d8 77 10 80 	movl   $0x801077d8,(%esp)
...
8010673a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
8010673d:	e8 3e bd ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106755:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106757:	e8 04 db ff ff       	call   80104260 <memset>
...
80106798:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106799:	e9 62 db ff ff       	jmp    80104300 <memmove>
    panic("inituvm: more than a page");
8010679e:	c7 04 24 01 78 10 80 	movl   $0x80107801,(%esp)
...
8010682d:	e8 0e b1 ff ff       	call   80101940 <readi>
...
80106852:	c7 04 24 1b 78 10 80 	movl   $0x8010781b,(%esp)
80106859:	e8 02 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010685e:	c7 04 24 bc 78 10 80 	movl   $0x801078bc,(%esp)
...
801068bb:	e8 a0 d9 ff ff       	call   80104260 <memset>
...
801068f5:	76 29                	jbe    80106920 <allocuvm+0xb0>
    mem = kalloc();
801068f7:	e8 84 bb ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106902:	c7 04 24 39 78 10 80 	movl   $0x80107839,(%esp)
...
80106930:	c7 04 24 51 78 10 80 	movl   $0x80107851,(%esp)
...
80106951:	e8 7a b9 ff ff       	call   801022d0 <kfree>
      return 0;
...
801069dd:	e8 ee b8 ff ff       	call   801022d0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
801069f2:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801069f3:	e9 d8 b8 ff ff       	jmp    801022d0 <kfree>
    panic("freevm: no pgdir");
801069f8:	c7 04 24 6d 78 10 80 	movl   $0x8010786d,(%esp)
...
80106a18:	e8 63 ba ff ff       	call   80102480 <kalloc>
...
80106a3b:	e8 20 d8 ff ff       	call   80104260 <memset>
...
80106adb:	c3                   	ret    
    panic("clearpteu");
80106adc:	c7 04 24 7e 78 10 80 	movl   $0x8010787e,(%esp)
...
80106b03:	0f 84 75 01 00 00    	je     80106c7e <copyuvm+0x18e>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106b2d:	e8 ce d7 ff ff       	call   80104300 <memmove>
...
80106b77:	0f 84 14 01 00 00    	je     80106c91 <copyuvm+0x1a1>
    if(!(*pte & PTE_P))
80106b7d:	8b 30                	mov    (%eax),%esi
80106b7f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b85:	0f 84 fa 00 00 00    	je     80106c85 <copyuvm+0x195>
    pa = PTE_ADDR(*pte);
...
80106b96:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106b9c:	e8 df b8 ff ff       	call   80102480 <kalloc>
...
80106bbe:	5d                   	pop    %ebp
80106bbf:	c3                   	ret    
  for(i = PGROUNDUP(UNDERKERN-myproc()->pages*PGSIZE); i < UNDERKERN; i += PGSIZE){
80106bc0:	e8 bb ca ff ff       	call   80103680 <myproc>
80106bc5:	8b 58 7c             	mov    0x7c(%eax),%ebx
80106bc8:	f7 db                	neg    %ebx
80106bca:	c1 e3 0c             	shl    $0xc,%ebx
80106bcd:	81 c3 00 a0 99 79    	add    $0x7999a000,%ebx
80106bd3:	81 fb 98 99 99 79    	cmp    $0x79999998,%ebx
80106bd9:	76 59                	jbe    80106c34 <copyuvm+0x144>
80106bdb:	e9 93 00 00 00       	jmp    80106c73 <copyuvm+0x183>
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106be0:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106be6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bed:	00 
80106bee:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106bf2:	89 04 24             	mov    %eax,(%esp)
80106bf5:	e8 06 d7 ff ff       	call   80104300 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106bfa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106bfd:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c03:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c07:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c0e:	00 
80106c0f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c13:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c17:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c1a:	89 04 24             	mov    %eax,(%esp)
80106c1d:	e8 4e f9 ff ff       	call   80106570 <mappages>
80106c22:	85 c0                	test   %eax,%eax
80106c24:	78 85                	js     80106bab <copyuvm+0xbb>
  for(i = PGROUNDUP(UNDERKERN-myproc()->pages*PGSIZE); i < UNDERKERN; i += PGSIZE){
80106c26:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c2c:	81 fb 98 99 99 79    	cmp    $0x79999998,%ebx
80106c32:	77 3f                	ja     80106c73 <copyuvm+0x183>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c34:	8b 45 08             	mov    0x8(%ebp),%eax
80106c37:	31 c9                	xor    %ecx,%ecx
80106c39:	89 da                	mov    %ebx,%edx
80106c3b:	e8 40 f7 ff ff       	call   80106380 <walkpgdir>
80106c40:	85 c0                	test   %eax,%eax
80106c42:	74 4d                	je     80106c91 <copyuvm+0x1a1>
    if(!(*pte & PTE_P))
80106c44:	8b 30                	mov    (%eax),%esi
80106c46:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c4c:	74 37                	je     80106c85 <copyuvm+0x195>
    pa = PTE_ADDR(*pte);
80106c4e:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c50:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c56:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c59:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c5f:	e8 1c b8 ff ff       	call   80102480 <kalloc>
80106c64:	85 c0                	test   %eax,%eax
80106c66:	89 c6                	mov    %eax,%esi
80106c68:	0f 85 72 ff ff ff    	jne    80106be0 <copyuvm+0xf0>
80106c6e:	e9 38 ff ff ff       	jmp    80106bab <copyuvm+0xbb>
80106c73:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106c76:	83 c4 2c             	add    $0x2c,%esp
80106c79:	5b                   	pop    %ebx
80106c7a:	5e                   	pop    %esi
80106c7b:	5f                   	pop    %edi
80106c7c:	5d                   	pop    %ebp
80106c7d:	c3                   	ret    
    return 0;
80106c7e:	31 c0                	xor    %eax,%eax
80106c80:	e9 33 ff ff ff       	jmp    80106bb8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106c85:	c7 04 24 a2 78 10 80 	movl   $0x801078a2,(%esp)
80106c8c:	e8 cf 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c91:	c7 04 24 88 78 10 80 	movl   $0x80107888,(%esp)
80106c98:	e8 c3 96 ff ff       	call   80100360 <panic>
...
80106cae:	e8 cd f6 ff ff       	call   80106380 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d76:	c7 44 24 04 e0 78 10 	movl   $0x801078e0,0x4(%esp)
80106d7d:	80 
